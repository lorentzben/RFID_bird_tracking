...
singularity run docker://lorentzb/rfid:2.4 Rscript room_2_analysis.r > ../logs/"$TS"_rm2.log

# Run Room 3 Individual Analysis 

singularity run docker://lorentzb/rfid:2.4 Rscript room_3_analysis.r > ../logs/"$TS"_rm3.log

# Run Room 8 Individual Analysis

singularity run docker://lorentzb/rfid:2.4 Rscript room_8_analysis.r > ../logs/"$TS"_rm8.log

# Run Room 11 Individual Analysis

singularity run docker://lorentzb/rfid:2.4 Rscript room_11_analysis.r > ../logs/"$TS"_rm11.log

# Run All Room Joint Analysis

singularity run docker://lorentzb/rfid:2.4 Rscript joint_analysis.r > ../logs/"$TS"_joint.log

# Run Social Network Analysis

singularity run docker://lorentzb/rfid:2.4 Rscript social_network.r > ../logs/"$TS"_network.log
