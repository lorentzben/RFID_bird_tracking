...
whole_data_sanity <- reslist2_6988[[1]]$daily_obj
...
write.csv(room_2_daily,"../output/room_2_daily_intra.csv",row.names = F)
write.csv(room_2_weekly,"../output/room_2_weekly_intra.csv",row.names = F)
write.csv(room_2_monthly,"../output/room_2_monthly_intra.csv",row.names = F)
