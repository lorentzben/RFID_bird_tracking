...
for(i in 1:length(bird_ids_room_8_new)){
  res <- sep_bird_id_period(samp_name="room 8",cage_obj =room_8, samp_id = bird_ids_room_8_new[i],cutoff = "2021-02-04 T22:00:00/2021-05-06 T23:00:00")
...
for(i in 1:length(bird_ids_room_11_new)){
  res <- sep_bird_id_period(samp_name="room 11",cage_obj =room_11, samp_id = bird_ids_room_11_new[i], cutoff="2021-02-01 T20:00:00/2021-05-07 T15:00:00")
