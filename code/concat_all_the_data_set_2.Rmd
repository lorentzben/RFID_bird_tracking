...
print("which birds are in this plot?")
print(low_act_bird_ids)
ggsave(q, filename="../figures/low_active_transitions_no_rm3_set_2.png",device="png")
```
...
print("which birds are in this plot?")
print(med_act_bird_ids)
ggsave(q, filename="../figures/med_active_transitions_no_rm3_set_2.png",device="png")
```
...
print("which birds are in this plot?")
print(high_act_bird_ids)
ggsave(q, filename="../figures/high_active_transitions_no_rm3_set_2.png",device="png")
```
