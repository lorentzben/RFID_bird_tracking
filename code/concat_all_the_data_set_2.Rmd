...
for(i in 1:length(bird_ids_room_2_new)){
  res <- sep_bird_id_period(samp_name="room 2",cage_obj =room_2, samp_id = bird_ids_room_2_new[i],cutoff = "2021-02-01 T20:00:00/2021-05-07 T13:00:00")
...
room_3 <- read.csv("../data/DK20-03-RFID-R3-febmay-080423.csv")
...
for(i in 1:length(bird_ids_room_3_new)){
  res <- sep_bird_id_period(samp_name="room 3",cage_obj=room_3, samp_id =bird_ids_room_3_new[i],cutoff = "2021-03-09 T20:00:00/2021-05-07 T14:00:00")
  #print(res)
  print(i)
  print(bird_ids_room_3_new[i])
...
for(i in 1:length(reslist2_room_3)){
  minute_period <- to_minute(reslist2_room_3[[i]]$xts_obj$subzone)
  minute_trans_table <- calc_trans_period(reslist2_room_3[[i]]$ID, minute_period, reslist2_room_3[[i]]$xts_obj, "Hr",0)  
  result <- list("ID"=reslist2_room_3[[i]]$ID,"hour"=minute_trans_table, "raw"=reslist2_room_3[[i]]$xts_obj)
