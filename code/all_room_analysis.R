...
ggsave(paste0("../figures/all_day/day_daily_time_budget_stack_bar_for_room_3",".png"), room_3_sb_plot)
...
ggsave(paste0("../figures/all_day/night_daily_time_budget_stack_bar_for_room_3",".png"), room_3_sb_night_plot)