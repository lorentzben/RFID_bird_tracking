...
drop.cols <- grep("tagname", colnames(rm_2))
rm_2[, (drop.cols)] <- NULL
...
drop.cols <- grep("tagname", colnames(rm_3))
rm_3[, (drop.cols)] <- NULL
...
drop.cols <- grep("tagname", colnames(rm_8))
rm_8[, (drop.cols)] <- NULL
...
drop.cols <- grep("tagname", colnames(rm_11))
rm_11[, (drop.cols)] <- NULL