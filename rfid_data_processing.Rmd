...
write.csv(december_to_feb_daily,"december_to_feb_daily_intra.csv",row.names = F)
write.csv(december_to_feb_weekly,"december_to_feb_weekly_intra.csv",row.names = F)
write.csv(december_to_feb_monthly,"december_to_feb_monthly_intra.csv",row.names = F)
```
...
write.csv(feb_to_may_daily,"feb_to_may_daily_intra.csv",row.names = F)
write.csv(feb_to_may_weekly,"feb_to_may_weekly_intra.csv",row.names = F)
write.csv(feb_to_may_monthly,"feb_to_may_monthly_intra.csv",row.names = F)
```
...
write.csv(mar_to_may_daily,"mar_to_may_daily_intra.csv",row.names = F)
write.csv(mar_to_may_weekly,"mar_to_may_weekly_intra.csv",row.names = F)
write.csv(mar_to_may_monthly,"mar_to_may_monthly_intra.csv",row.names = F)
...
p
ggsave(p, filename = "most_active_bird_pca.png",device = "png",width = unit(7,"in"),height=unit(7,"in"))
...
most_active_grp <- data.frame(x = most_active_intra_day$day, y = c(most_active_intra_day$bottom, most_active_intra_day$mid, most_active_intra_day$top), group= c(rep("Bottom",nrow(most_active_intra_day)),rep("Mid",nrow(most_active_intra_day)),rep("Top",nrow(most_active_intra_day))))
 ...
 q <- ggplot(most_active_grp, aes(x,y,col=group))+
  ...
  theme_bw()
q
ggsave(q, filename = "most_active_transitions_per_day.png",device="png")
...
p <- ggplot(pr.feb$x[,1:2], aes(x=PC1, y=PC2, color=as.character(most_active_intra_hourly$cluster)))+
  ...
  theme(legend.position = "bottom", legend.direction = "vertical",legend.text = element_text(size=8))
p
ggsave(p, filename = "most_active_bird_pca_hourly.png",device = "png",width = unit(7,"in"),height=unit(7,"in"))
...
most_active_grp <- data.frame(x = most_active_intra_hourly$hour, y = c(most_active_intra_hourly$bottom, most_active_intra_hourly$mid, most_active_intra_hourly$top), group= c(rep("Bottom",nrow(most_active_intra_hourly)),rep("Mid",nrow(most_active_intra_hourly)),rep("Top",nrow(most_active_intra_hourly))))
 ...
 q <- ggplot(most_active_grp, aes(x,y,col=group))+
  ...
  theme_bw()
q
ggsave(q, filename = "most_active_transitions_per_hour.png",device="png")
...
ggsave(q, filename="low_active_transitions.png",device="png")
```
...
ggsave(q, filename="med_active_transitions.png",device="png")
```
...
ggsave(q, filename="high_active_transitions.png",device="png")
```
...
write.csv(december_to_feb_daily,"december_to_feb_daily_inter.csv",row.names = F)
write.csv(december_to_feb_weekly,"december_to_feb_weekly_inter.csv",row.names = F)
write.csv(december_to_feb_monthly,"december_to_feb_monthly_inter.csv",row.names = F)
```
...
write.csv(feb_to_may_daily,"feb_to_may_daily_inter.csv",row.names = F)
write.csv(feb_to_may_weekly,"feb_to_may_weekly_inter.csv",row.names = F)
write.csv(feb_to_may_monthly,"feb_to_may_monthly_inter.csv",row.names = F)
```
...
write.csv(mar_to_may_daily,"mar_to_may_daily_inter.csv",row.names = F)
write.csv(mar_to_may_weekly,"mar_to_may_weekly_inter.csv",row.names = F)
write.csv(mar_to_may_monthly,"mar_to_may_monthly_inter.csv",row.names = F)
...
ggsave(q, filename="duration_transitions.png",device="png")
```
...
hold_dur
write.csv(hold_dur,"ordered_by_total_sum.csv",row.names = F)
...
cluster_table_dur
write.csv(cluster_table_dur,"new_cohort.csv", row.names = F)
...
print("which birds are in this plot?")
print(low_act_bird_ids)
ggsave(q, filename="low_active_new_cohort_duration.png",device="png")
...
print("which birds are in this plot?")
print(med_act_bird_ids)
ggsave(q, filename="med_active_new_cohort_duration.png",device="png")
...
print("which birds are in this plot?")
print(high_act_bird_ids)
ggsave(q, filename="high_active_new_cohort_duration.png",device="png")
...
print("which birds are in this plot?")
print(low_act_bird_ids)
ggsave(q, filename="low_active_old_cohort_duration.png",device="png")
...
print("which birds are in this plot?")
print(med_act_bird_ids)
ggsave(q, filename="med_active_old_cohort_duration.png",device="png")
...
print("which birds are in this plot?")
print(high_act_bird_ids)
ggsave(q, filename="high_active_old_cohort_duration.png",device="png")
```
