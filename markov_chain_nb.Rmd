...
day1_6894 <- xts_6894[paste0("2020-11-16 20:39:26","/",index(daily_6894)[2])]

tmp <- calc_trans("6894.d1", data.frame(day1_6894))

#TODO turn this into a function

result <- data.frame()
for (i in 2:length(daily_6894)){
  curr_day <- xts_6894[paste0(index(daily_6894)[i-1],"/",index(daily_6894)[i])]
  curr_day_trans <- calc_trans(paste0("6984.d",i),curr_day)
