...
reslist2_6894 <- list()
for(i in 1:10){
  res <- sep_bird_id_period(samp_name="6894",cage_obj =six_eight_nine_four, samp_id = bird_ids_6894[i],cutoff = "2020-12-02 23:00:00/2021-01-22 10:00:00")
  reslist2_6894[[i]] <- res
}
...
reslist3_6894 <- list()
for(i in 11:15){
  res <- sep_bird_id_period(samp_name="6894",cage_obj =six_eight_nine_four, samp_id = bird_ids_6894[i],cutoff = "2021-02-18 T16:00:00/2021-05-05 T23:00:00")
  reslist3_6894[[i]] <- res
}
...
for(i in 1:length(bird_ids_6928_new)){
  res <- sep_bird_id_period(samp_name="6928",cage_obj =six_nine_two_eight, samp_id = bird_ids_6928_new[i],cutoff = "2021-02-05 T16:00:00/2021-05-05 T23:00:00")
  reslist2_6928[[i]] <- res
}
