...
remove <- c("6862","6880","6881","6882","6887","6891","6892","6893","6894","6900","9059")
...
for(item in trans_reslist_6894_dec){
  december_to_feb_daily <- rbind(december_to_feb, item$daily[c("ID","bottom","mid","top","total")])
  december_to_feb_weekly <- rbind(december_to_feb, item$weekly[c("ID","bottom","mid","top","total")])
  december_to_feb_monthly <- rbind(december_to_feb, item$monthly[c("ID","bottom","mid","top","total")])
}
...
```{r, try to work with the 2-18 datasets}
